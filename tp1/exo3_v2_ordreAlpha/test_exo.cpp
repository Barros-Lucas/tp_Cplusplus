...
int main(){
    ...
    TPersonne* personne2 = tp::new_personne("cbarros2","lucas2","mail2","adresse2","id2");
    ajoute(liste, personne2);
    TPersonne* personne3 = tp::new_personne("abarros3","lucas3","mail3","adresse3","id3");
    ajoute(liste, personne3);
    TPersonne* personne4 = tp::new_personne("dbarros4","lucas4","mail4","adresse4","id4");
